"""
Kuro OS — Job Sync Engine (DuckDuckGo Discovery + Career Page Scraping)
...
from kuro.agents import job_scorer
...
from kuro.tools.ats_client import Company, Job, fetch_jobs, probe_company
from kuro.tools import hasjob, liveness
...
async def run_sync(
    ...
    from kuro.agents import job_search_agents
