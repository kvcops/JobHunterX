"""
Vellum OS — Multi-Agent Job Discovery & Evaluation Engine
...
async def evaluate_single_job(job: dict, profile: dict, plan: dict) -> dict:
    ...
    from vellum.agents.job_scorer import _keyword_score
...
async def run_multi_agent_search(
    ...
    from vellum.agents.job_scorer import _keyword_score, score_batch
