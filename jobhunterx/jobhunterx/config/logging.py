"""
JobHunterX — Premium Terminal Logging Configuration

Clean, high-visibility, colorized structured logging for JobHunterX agents.
...
class StandardLoggerAdapter:
    ...
    def __init__(self, name: str = "jobhunterx"):
...
def get_logger(name: str | None = None):
    ...
    if HAS_STRUCTLOG:
        ...
        return StandardLoggerAdapter(name or "jobhunterx")
